...
//	GPIO_InitTypeDef  GPIO_InitStructure;
    ...
    RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOE,ENABLE);//先使能外设IO PORTC时钟 
...
//	STMFLASH_Read(0,(u32*)&Vl53l0x_data,sizeof(_vl53l0x_adjust));
...
void vl53l0x_test(void)
{
	...
	{
		 vl53l0x_info();
//		 vl53l0x_calibration_test(&vl53l0x_dev);          //校准模式
		 vl53l0x_general_test(&vl53l0x_dev);              //普通测量模式
