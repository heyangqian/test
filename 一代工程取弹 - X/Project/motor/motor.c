...
void x_set_change()
{
	...
	{
		x_p_pid.SetNum = -1000000;
	}
	else if(mov_flag == 2)         // 2. 设定值880000   最大上限  890000
	{
		x_p_pid.SetNum = 850000;
	}
}
/**********************change***************
	函数名：claw_set_change
...
void x_limit()
{
	if(x_p_pid.ActualNum <= -900000 && mov_flag == 1)
	{
		x_p_pid.Act_num = -900000;
	}
	else if(x_p_pid.ActualNum >= 900000 && mov_flag == 2)
	{
		x_p_pid.Act_num = 900000;
	}
	else if(x_p_pid.ActualNum <= -10000 && mov_flag == 3)
	{
		x_p_pid.Act_num = -10000;
	}
	else
	{
...
void claw_limit()
{
	if(Claw_p_pid.ActualNum >= 105000 && gas_flag == 1)////////////////改//////////
	{
		Claw_p_pid.Act_num = 105000;/////////////////改////////////////
	}
	else if(Claw_p_pid.ActualNum <= -3000 && gas_flag == 2)
	{
		Claw_p_pid.Act_num = -3000;
	}
	else if(Claw_p_pid.ActualNum >= 40000 && gas_flag == 3)
	{
		Claw_p_pid.Act_num = 40000;
	}
	else if(Claw_p_pid.ActualNum <= 2000 && gas_flag == 4)
	{
		Claw_p_pid.Act_num = 2000;
	}
	else if(Claw_p_pid.ActualNum <= -3000 && gas_flag == 5)
	{
		Claw_p_pid.Act_num = -3000;
	}
	else
...
void send_limit()
{
	if(Send_p_pid.ActualNum <= -350000 && mos_flag == 1)
	{
		Send_p_pid.Act_num = -350000;
	}
	else if(Send_p_pid.ActualNum >= 10000 && mos_flag == 0)
	{
		Send_p_pid.Act_num = 10000;
	}
	else
	{
